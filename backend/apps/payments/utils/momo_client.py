...
def create_momo_payment(amount, order_info="Payment with MoMo", booking_id: str | None = None):
    ...
    # redirect thẳng về BookingDetail
    if not booking_id:
        raise ValueError("Thiếu booking_id để tạo redirectUrl động.")
    redirect_url = f"{settings.FRONTEND_URL}/dashboard/orders/{booking_id}"
